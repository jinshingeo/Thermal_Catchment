...
| **OSM 건물 + 도시숲 캐노피** | 이 연구에서 사용 (2026-05-20 업데이트) | UMEP 10m 캐노피를 유효 H에 합산 |

**반영 방식**: $H_{eff} = H_{건물} + H_{캐노피} \times \text{canopy\_ratio}$  
- $H_{캐노피}$ = 10m (UMEP TreePlanter Tutorial; Lindberg et al.)  
- 도시숲 전체(도시숲·마을숲·경관숲·학교숲·가로수) 반영  
- 캐노피 있는 링크: 4,403개 (56.3%), 평균 캐노피 비율 11.6%
