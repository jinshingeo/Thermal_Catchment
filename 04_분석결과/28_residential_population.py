...
입력:
  01_네트워크/LOCAL_PEOPLE_202507/  — 2025년 7월 일별 생활인구 (집계구 단위)
  01_네트워크/LOCAL_PEOPLE_202508/  — 2025년 8월 일별 생활인구 (집계구 단위)
  01_네트워크/통계지역경계(2016년+기준)/집계구.shp  — 집계구 경계
...
NET_DIR  = os.path.join(BASE, '../01_네트워크')
POP_DIR7 = os.path.join(NET_DIR, 'LOCAL_PEOPLE_202507')
POP_DIR8 = os.path.join(NET_DIR, 'LOCAL_PEOPLE_202508')
DONG_SHP = os.path.join(NET_DIR, '통계지역경계(2016년+기준)/집계구.shp')
OUT_DIR  = BASE
