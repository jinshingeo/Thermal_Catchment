...
svf_df  = pd.read_csv(os.path.join(BASE, 'link_svf_canopy.csv'), encoding='utf-8-sig')
sol_df  = pd.read_csv(os.path.join(BASE, 'link_utci_solweig.csv'), encoding='utf-8-sig')
corr_df = pd.read_csv(os.path.join(BASE, 'link_utci_corrected.csv'), encoding='utf-8-sig')

with open(os.path.join(BASE, 'catchment_solweig_summary.json'), encoding='utf-8') as f:
    summary = json.load(f)
...
df_station.to_csv(os.path.join(BASE, 'regression_station_vars.csv'), index=False, encoding='utf-8-sig')
...
with open(os.path.join(BASE, 'regression_results.json'), 'w', encoding='utf-8') as f:
